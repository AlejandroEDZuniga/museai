    ...
    >
      <div className="relative pointer-events-none">
        ...
        <Image
          src="/images/black_circle_360x360.png"
          alt="Made in Bolt.new"
          width={isInline ? 32 : 96}
          height={isInline ? 32 : 96}
          className={`${
            isInline ? 'w-6 h-6' : 'w-16 h-16 sm:w-24 sm:h-24'
          } object-contain transition-all duration-300 drop-shadow-lg pointer-events-auto`}
          priority
          quality={95}
        />
      </div>
